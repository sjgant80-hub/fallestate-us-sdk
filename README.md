...
**FallEstate · The sovereign island · AI-Native Solutions** — sovereign SDK extracted from `fallestate-us/index.html`.

## Install
```bash
npm install @ai-native-solutions/fallestate-us-sdk
```

## Use
```js
import * as fallestate-us from '@ai-native-solutions/fallestate-us-sdk';
```

- Playground: https://sjgant80-hub.github.io/fallestate-us-sdk/
- MCP wrapper: [`@ai-native-solutions/fallestate-us-mcp`](https://github.com/sjgant80-hub/fallestate-us-mcp)
- HTTP API: [`@ai-native-solutions/fallestate-us-api`](https://github.com/sjgant80-hub/fallestate-us-api)
...
- **Discoverable** — indexed on the FallMarket catalog at [sjgant80-hub.github.io/fallmarket/listing.html?id=fallestate-us-sdk](https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallestate-us-sdk)
...
- **Companion SDK** (`npm install @ai-native-solutions/fallestate-us-sdk-sdk`) — programmatic JavaScript API for direct integration.
- **Companion MCP server** (`claude mcp add fallestate-us-sdk -- npx -y @ai-native-solutions/fallestate-us-sdk-mcp`) — Model Context Protocol server that any Claude/Cursor/Codex client can invoke as a tool.
- **Companion HTTP API** (`docker run --rm ghcr.io/sjgant80-hub/fallestate-us-sdk-api`) — containerized REST endpoint for language-agnostic access.
...
- **Registry entry**: https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallestate-us-sdk
- **Live URL**: https://sjgant80-hub.github.io/fallestate-us-sdk/
- **Source**: https://github.com/sjgant80-hub/fallestate-us-sdk
